document.addEventListener("DOMContentLoaded", function () {
    ...
    function getFirstUrl() {
        const panelWithUrl = document.querySelector("[data-notifications-auto-panel][data-notifications-url]");
        const headerWithUrl = document.querySelector("[data-notifications-header][data-notifications-url]");
    ...
    function getFirstInterval() {
        const source =
            document.querySelector("[data-notifications-header][data-notifications-interval]") ||
            document.querySelector("[data-notifications-auto-panel][data-notifications-interval]");

        const interval = Number(source?.dataset.notificationsInterval || DEFAULT_INTERVAL);
    ...
    function updateHeaderUnreadCount(unreadCount) {
        ...
        headers.forEach(function (header) {
            const dot = header.querySelector("[data-notifications-dot]");
            const badge = header.querySelector("[data-notifications-count-badge]");
            const countText = header.querySelector("[data-notifications-count]");
    ...
    function updatePanels(data) {
        panels.forEach(function (panel) {
            ...
            panel.dataset.notificationsPage = data.page || panel.dataset.notificationsPage || "1";
        });
    }
