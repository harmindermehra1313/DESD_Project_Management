...
function getStatusBadgeClass(status) {
  ...
  if (value.includes("packaged")) return "bg-success";
...
function openRecurringDetails(subId) {
  ...
  // Summary cards (mirrors order detail layout)
  const summaryHtml = `
    <div class="row g-3 mb-4">
      <div class="col-md-3">
        <div class="border rounded p-3 h-100">
  ...
  // Items table (mirrors order detail items section)
  const itemsHtml = `
    <div class="mb-4">
      <h6 class="mb-3">Items</h6>
      <div class="table-responsive">
  ...
  // Delivery / collection details (mirrors fulfilment section)
  const deliveryHtml = `
    <div class="mb-4">
      <h6 class="mb-3">Delivery / Collection Details</h6>
      <div class="row g-3">
