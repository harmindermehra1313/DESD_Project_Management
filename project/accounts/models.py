...
class Producer(models.Model):
    ...
    organic_certification_number = models.CharField(max_length=100, null=True, blank=True)
...
class Customer(models.Model):
    ...
    organisation_type = models.CharField(max_length=150, null=True, blank=True)
    registration_number = models.CharField(max_length=100, null=True, blank=True)
    contact_person_name = models.CharField(max_length=150, null=True, blank=True)
    billing_preferences = models.JSONField(null=True, blank=True)
