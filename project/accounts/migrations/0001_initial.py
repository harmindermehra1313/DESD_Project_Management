    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('CUSTOMER', 'Customer'), ('PRODUCER', 'Producer'), ('COMMUNITY_GROUP', 'Community Group'), ('RESTAURANT', 'Restaurant'), ('ADMIN', 'Admin')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payout_method', models.CharField(choices=[('BANK_TRANSFER', 'Bank Transfer'), ('PAYPAL', 'PayPal'), ('MANUAL', 'Manual')], max_length=20)),
