...
class Notification(models.Model):
    ...
    product_id = models.ForeignKey(Product, on_delete=models.CASCADE, db_column="product_id", null=True)
    order_id = models.ForeignKey(Order, on_delete=models.CASCADE, db_column="order_id", null=True)
